...
| [株式会社MTS](#株式会社mts)                                               | 2018/04/01 \~ 2019/03 | インフラエンジニア/PHPエンジニア|
| [株式会社Eta Consulting](#株式会社eta-consulting)                         | 2016/01 \~ 2018/04    | インフラエンジニア/PHPエンジニア          |
| [株式会社アップクロス](#株式会社アップクロス] | 2015/01 \~ 2016/01    | インフラエンジニア/PHPエンジニア        |
...
- **役割**
  - エンジニアリングマネージャー
- **プロジェクト詳細** 
  - 自社ナイトレジャー系ポータルサイトのAWSリソース構築・運用・自動化推進を担当。
...
- **役割**
  - プロジェクトリーダー
- **プロジェクト詳細**
  - 自社ナイトレジャー系ポータルサイトの機能追加,保守運用,速度改善等を担当。
...
- **役割**
  - フルスタックエンジニア
- **プロジェクト詳細**
  - 自社サービスのPOSシステムのバックエンド開発・保守運用・速度改善等を担当
  - インフラ構築・運用
...
- **役割**
  - フルスタックエンジニア
- **プロジェクト詳細**
  - 自社サービスのポイントサイトのバックエンド開発・保守運用・速度改善等を担当
  - 自社広告システムの機能構築・運用
...
- **役割**
  - インフラエンジニア・PHPエンジニア
- **プロジェクト詳細**
  - 不動産サイトのAWSリプレイス,キュレーションサイトの新規構築案件
  - Docomo公式AndroidアプリへPush通知システムのバックエンド構築
  - 某スマホゲームアプリのサーバーサイドエンジニア
